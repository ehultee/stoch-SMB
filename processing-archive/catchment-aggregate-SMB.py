...
csv_ctchmnt = '/Users/lizz/Documents/GitHub/Data_unsynced/SMBMIP-processed/{}-helheim_catchment-tseries.csv'.format(datetime.date.today().strftime('%Y%m%d'))

...
# model_names = ['NHM-SMAP_niwano', 'dEBM_krebs']
...
# accum_ts_1980 = [smb_nhm[i][accum_pt_yi, accum_pt_xi] for i in range(len(smb_nhm))]
# abl_nw_ts_1980 = [smb_nhm[i][abl_nw_yi, abl_nw_xi] for i in range(len(smb_nhm))]
# abl_se_1980 = [smb_nhm[i][abl_se_yi, abl_se_xi] for i in range(len(smb_nhm))]

# ## Example subplots
# fig, (ax1, ax2) = plt.subplots(2)
# ax1.imshow(smb_nhm[0][::,::])
# ax2.imshow(smb_debm[0][::,::])
# # ax3.imshow(smb_raw[8][::-1,::])
# plt.show()

# plt.figure()
# plt.plot(accum_ts_1980)
# plt.plot(abl_nw_ts_1980)
# plt.plot(abl_se_1980)
# plt.show()
